...
export const inventoryTurnover = pgTable("inventory_turnover", {
    year: integer(),
    month: integer(),
    week: integer(),
    plant: varchar({ length: 50 }),
    plant_code: varchar({ length: 50 }),
    business_unit: varchar({ length: 50 }),
    mtyp: varchar({length: 50}),
    material_code: varchar({ length: 50 }),
    material_desc: varchar({ length: 100 }),
    kind_of_product: varchar({ length: 50 }),
...
export const trendAnalysisMonthly = pgView("it_trend_analysis_monthly", { 
    year: integer(),
    month: integer(),
    overall_turnover: numeric(),
    fish_turnover: numeric(),
    shrimp_turnover: numeric(),
    best_performing: varchar(),
    worst_performing: varchar(),
}).as(sql`
...
export const plantPerformanceDetailMonthly = pgView("it_plant_performance_detail_monthly", {
    plant: varchar({ length: 50 }),
    business_unit: varchar({ length: 50 }),
    year: integer(),
    jan: numeric(),
    ...
    nov: numeric(),
    dec: numeric(),
    inventory_turnover_ytd: numeric("inventory_turnover_ytd"),
}).as(sql`
...
export const plantPerformanceDetailMonthlyDOI = pgView("doi_plant_performance_detail_monthly", {
    plant: varchar({ length: 50 }),
    business_unit: varchar({ length: 50 }),
    year: integer(),
    jan: numeric(),
    ...
    nov: numeric(),
    dec: numeric(),
    days_of_inventory_ytd: numeric("days_of_inventory_ytd"),
}).as(sql`
WITH Code_Summary AS (
    SELECT
        t1.year,
